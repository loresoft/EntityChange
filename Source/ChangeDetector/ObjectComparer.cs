...
using ChangeDetector.Extenstions;
using ChangeDetector.Fluent;
...
namespace ChangeDetector
{
    public class ObjectComparer
    {
        ...
        public ObjectComparer() : this(Configuration.Default)
        {
        }

        public ObjectComparer(Configuration configuration)
        {
